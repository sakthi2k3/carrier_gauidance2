...
from datasets import healthcare_data_set as data_set
from datasets import healthcare_question_options as question_options
from datasets import healthcare_questions as questions
...
def predict_domain(responses):
    ...
    domains = ["Telemedicine and telehealth", "Healthcare data and analyticse", "Digital health", "Biotechnology and medical devices"]  # Update with actual domain names
